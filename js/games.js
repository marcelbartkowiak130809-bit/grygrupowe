import { renderGame } from "./game.js?v=20260903-9";
import { impostorDefaults, renderImpostorGameStable as renderImpostorGame } from "./impostor.js?v=20260903-9";
import { identityDefaults, renderIdentityGame } from "./identity.js?v=20260903-9";
import { otherQuestionDefaults, renderOtherQuestionGame } from "./otherQuestion.js?v=20260903-9";
import { renderWouldYouRather } from "./wouldYouRather.js?v=20260903-9";
import { mostLikelyDefaults, renderMostLikelyGame } from "./mostLikely.js?v=20260903-9";
import { friendshipDefaults, renderFriendshipTestGame } from "./friendshipTest.js?v=20260903-9";
import { poisonCandyDefaults, renderPoisonCandyGame } from "./poisonCandy.js?v=20260903-9";
import { bombDefaults, renderBombGame } from "./bomb.js?v=20260903-9";
import { closestTruthDefaults, renderClosestTruthGame } from "./closestTruth.js?v=20260903-9";
import { rankingDefaults, renderRankingGame } from "./ranking.js?v=20260903-9";
import { fiveSecondsDefaults, renderFiveSecondsGame } from "./fiveSeconds.js?v=20260903-9";
import { clockDefaults, renderClockGame } from "./clock.js?v=20260903-9";
import { pokemonDefaults, renderPokemonGame } from "./pokemon.js?v=20260903-9";
import { wavelengthDefaults, renderWavelengthGame } from "./wavelength.js?v=20260903-9";
import { quizDefaults, renderQuizGame } from "./quiz.js?v=20260903-9";
import { mathematicsDefaults, renderMathematicsGame } from "./mathematics.js?v=20260903-9";
import { markerDefaults, renderMarkerGame } from "./marker.js?v=20260903-9";
import { sequenceDefaults, renderSequenceGame } from "./sequence.js?v=20260903-9";
import { familyDefaults, renderFamilyGame } from "./family.js?v=20260903-9";
import { wordChainDefaults, renderWordChainGame } from "./wordChain.js?v=20260903-9";
import { numberMysteryDefaults, renderNumberMysteryGame } from "./numberMystery.js?v=20260903-9";
import { uniqueAnswerDefaults, renderUniqueAnswerGame } from "./uniqueAnswer.js?v=20260903-9";
import { connectDefaults, renderConnectGame } from "./connect.js?v=20260903-9";
import { liarDefaults, renderLiarGame } from "./liar.js?v=20260903-9";
import { falseMessageDefaults, renderFalseMessageGame } from "./falseMessage.js?v=20260903-9";
import { secretRuleDefaults, renderSecretRuleGame } from "./secretRule.js?v=20260903-9";
import { musicDuelDefaults, musicArenaDefaults, renderMusicDuelGame, renderMusicArenaGame } from "./music.js?v=20260926-1";
import { lyricsDefaults, renderLyricsGame, renderLyricsSolo } from "./lyrics.js?v=20260926-1";
import { popularityDefaults, renderPopularityGame, renderPopularitySolo } from "./popularity.js?v=20260926-1";
import { renderSongSpotGame, renderSongSpotSolo, songSpotDefaults } from "./songSpot.js?v=20260926-1";
